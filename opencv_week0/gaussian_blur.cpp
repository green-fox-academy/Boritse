...
int main(int argc, char** argv)
{
	...
	Mat image = imread("bebino_sitting.jpg");
		...
		GaussianBlur(image, image_blurred_with_5x5_kernel, Size(15, 15), 0);

		//Define names of the windows
		String window_name = "Bebino";
		String window_name_blurred_with_3x3_kernel = "Bebino Blurred with 3 x 3 Gaussian Kernel";
		String window_name_blurred_with_5x5_kernel = "Bebino Blurred with 5 x 5 Gaussian Kernel";
		...
		resizeWindow(window_name_blurred_with_3x3_kernel, image.cols / 4, image.rows / 4);
		resizeWindow(window_name_blurred_with_5x5_kernel, image.cols / 4, image.rows / 4);
