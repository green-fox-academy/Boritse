...
int main(void)
{
    ...
    TimHandle.Init.Prescaler	= 5*10800 - 1;	/* 108000000/10800=10000 -> speed of 1 count-up: 1/10000 sec = 0.1 ms */
    TimHandle.Init.Period		= 10000 - 1;	/* 10000 x 0.1*5 ms = 5 second period */
    ...
    green_led.Pin = GPIO_PIN_10; /* setting up 2 pins at once with | operator */
